...
public class EcommerceRegistrationTest extends EcommerceBasePageTest {

    @Test
    public void registrarCuenta() throws InterruptedException {
    ...
    public void uniqueAccount() throws InterruptedException {
        ...
        //Cerramos sesion
        EcommerceAuthenticationPage previewEcommerceAuthenticationPage= newEcommerceMyPersonalInformationPage.signOutBtnClick();
        Assert.assertEquals(previewEcommerceAuthenticationPage.getNameSignInBtn(),"Sign in", "El nombre del botón no es el correcto");

        previewEcommerceAuthenticationPage.fillEmailUserUnique();
        previewEcommerceAuthenticationPage.createAccountPreexistingBtn();

        Assert.assertEquals(previewEcommerceAuthenticationPage.getMessageErrorUniqueEmail(),"An account using this email address has already been registered. Please enter a valid password or request a new one.","Se esperaba otro mensaje de error");
    }
}
